  ...
  return (
    <>
      ...
      <main className={`${styles.main} ${inter.className}`}>
        ...
        <div>Type your message that you want to make more polite and friendly.</div>
        <div>Politer AI will transform your message into a more courteous and respectful one.</div>
        <div>So you can maintain a positive relationship with your recipient.</div>
